...
using SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Encryption;
#endif

using SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Core;
using SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Checksums;
using SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip.Compression;

namespace SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip 
{
    ...
    /// using System.IO;
    /// 
    /// using SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip;
    /// 
    /// class MainClass
    /// {
