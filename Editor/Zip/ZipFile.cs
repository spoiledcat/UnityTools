...
#region Keys Required Event Args
	...
	/// </code>
	/// </example>
	public class ZipFile : IEnumerable, IDisposable, IArchive
	{
		#region KeyHandling
		...
		/// </exception>
		/// <exception cref="SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip.ZipException">
		...
		*/
		...
		public IArchiveEntry FindEntry(string file)
		{
			return null;
		}
	}
