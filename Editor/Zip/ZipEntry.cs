...
namespace SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipEntry : IArchiveEntry
	{
		...
		/// </returns>
		/// <see cref="SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip.CompressionMethod.Deflated"/>
		/// <see cref="SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip.CompressionMethod.Stored"/>
		...
		{
			get { return ExternalFileAttributes; }
		}
        ...
        public DateTime LastModifiedTime { get { return DateTime; } }
