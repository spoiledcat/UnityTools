...
namespace SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip.Compression.Streams
{
	/// <summary>
	...
	/// as the <see cref="SpoiledCat.Utilities.ICSharpCode.SharpZipLib.GZip.GZipInputStream">GZipInputStream</see>.
	///
