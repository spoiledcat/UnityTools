...
namespace SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Tar
{
	...
	public class TarEntry : IArchiveEntry
	{
        ...
        public int FileAttributes { get { return TarHeader.Mode; } }
		public bool IsSymLink { get { return TarHeader.TypeFlag == TarHeader.LF_SYMLINK; } }
		public bool IsLink { get { return TarHeader.TypeFlag == TarHeader.LF_LINK; } }
        public DateTime LastModifiedTime { get { return ModTime; } }
