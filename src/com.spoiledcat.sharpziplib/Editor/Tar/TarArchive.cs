...
namespace SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Tar
{
	/// <summary>
	...
	/// </summary>
	public class TarArchive : IEnumerable, IDisposable, IArchive
	{
		/// <summary>
		/// Gets an enumerator for the tar entries in this archive.
		/// </summary>
		...
		public IEnumerator GetEnumerator()
		{
			...
			return new TarEntryEnumerator(tarIn);
		}

		/// <summary>
		/// An <see cref="IEnumerator">enumerator</see> for <see cref="ZipEntry">Zip entries</see>
		/// </summary>
		private class TarEntryEnumerator : IEnumerator
		{
            #region Constructors
		...
		public Stream GetInputStream(IArchiveEntry entry)
		{
			return tarIn;
		}

		public TarInputStream TarInputStream
		{
			get { return tarIn; }
		}
		...
		public IArchiveEntry FindEntry(string filename)
		{
		...
		public void ExtractAndTranslateEntry(string destFile, Stream outputStream)
		{
