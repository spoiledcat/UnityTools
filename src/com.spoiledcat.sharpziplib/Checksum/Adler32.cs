...
namespace SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Checksum
{
	/// <summary>
	...
	///    checksum of zero.)"
	/// </summary>
	/// <see cref="SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip.Compression.Streams.InflaterInputStream"/>
	/// <see cref="SpoiledCat.Utilities.ICSharpCode.SharpZipLib.Zip.Compression.Streams.DeflaterOutputStream"/>
